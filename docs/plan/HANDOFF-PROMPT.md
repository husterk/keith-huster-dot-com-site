...
- Work through pull requests, not direct pushes to `main`, once branch protection exists. Rebase-merge (linear history; no squash or merge commits). Keep PRs small enough to review. Merge your own PRs once CI is green; Keith does not review each one.
